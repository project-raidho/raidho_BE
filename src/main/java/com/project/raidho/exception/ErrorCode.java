...
public enum ErrorCode {
    ...
    DIDNT_CHECK_STAR(HttpStatus.BAD_REQUEST, "해당 게시글에 찜을한 적이 없습니다."),
    ...
    DOESNT_EXIST_CATEGORY(HttpStatus.BAD_REQUEST, "해당 카테고리가 없습니다."),
    CHATTING_ROOM_ALREADY_FULL(HttpStatus.BAD_REQUEST, "채팅방 수용인원을 초과할 수 없습니다."),
    ...
    DOESNT_EXIST_MEETING_POST(HttpStatus.NOT_FOUND, "존재하지 않는 모집글입니다."),
    DOESNT_EXIST_CHATTING_ROOM(HttpStatus.NOT_FOUND, "존재하지 않는 채팅방입니다.");
